// รายการผลการค้นหา 1 แถว - ออกแบบให้กะทัดรัด อ่านเร็ว ตาม use case "ยืนอยู่ในร้านหนังสือ"
...
export default function SearchResultItem({ series }: SearchResultItemProps) {
  ...
  return (
    <Link
      to={`/series/${series.id}`}
      className="flex items-center justify-between px-4 py-3 hover:bg-slate-800 transition-colors border-b border-slate-800"
    >
